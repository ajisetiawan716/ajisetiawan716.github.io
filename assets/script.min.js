...
$("#btn-qris-2").click(function(){$("#qr-qris-2").modal("show")}),  
$("#btn-bri").click(function(){$("#qr-bri").modal("show")}),
...
$("#btn-seabank").click(function(){$("#qr-seabank").modal("show")}),
$("#btn-paypal").click(function(){$("#qr-paypal").modal("show")}),
$("#btn-jago").click(function(){$("#qr-jago").modal("show")}),
$("#btn-flip").click(function(){$("#qr-flip").modal("show")}),
$("#btn-trakteer").click(function(){$("#qr-trakteer").modal("show")});
